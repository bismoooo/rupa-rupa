...
<head>
    ...
    <title>Keranjang - RupaRupa Admin</title>
...
<body>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        $filter_karegori = isset($_GET['kategori']) ? $_GET['kategori'] : '';
                        ?>

                        <div class="filter-bar mt-3">
                            <from class="filter-form d-flex align-item-center" menthod="GET"
                            action="">
                                ...
                                200px;" title="Pilih Kategori">
                                    ...
                                    if ($result_kategori->num_rows > 0) {
                                        while ($row = $result_kategori->fetch_assoc()) {
                                            $selected = ($filter_karegori == $row['id_kategori']) ? 
                                            "selected" : "";
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            if (!empty($filter_karegori)) {
                                $sql .= " WHERE k.id_kategori = '$filter_karegori'";
                            }
    ...
    <footer id="footer" class="footer">
        ...
        <div class="credits">
            Designed by <a href="https://www.instagram.com/bsmawhy">Bismooooooooo</a>
        </div>
    </footer><!-- End Footer -->
