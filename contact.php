...
<head>
  ...
  <title>Hubungi kami-RupaRupa</title>
        ...
        <div class="d-none d-sm-block mb-5 pb-4">
            ...
            <div class="map-container">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3958.
                    ...
                    Cepu!5e0!3m2!1sid!2sid!4v1743766946322!5m2!1sid!2sid" 
                    width="100%" 
                    height="450" 
                    style="border:0;" 
                    allowfullscreen="" 
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9"
                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'Masukan pesan'"
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="name" id="name" type="text" onfocus="this.placeholder = ''"
                    onblur="this.placeholder = 'Masukan Nama Anda'" placeholder='Masukan Nama Anda'>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="email" id="email" type="email" onfocus="this.placeholder = ''"
                    onblur="this.placeholder = 'Masukan Alamat Email'" placeholder='Masukan Alamat Email'>
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
                  <input class="form-control" name="subject" id="subject" type="text" onfocus="this.placeholder = ''"
                    onblur="this.placeholder = 'Masukan Subjek'" placeholder='Masukan Subjek'>
                </div>
              </div>
            </div>
